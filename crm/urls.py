...
urlpatterns = [
    ...
    path('api/admin/criar-resultado/', views_config.criar_resultado, name='criar_resultado'),
    path('api/admin/editar-resultado/<int:resultado_id>/', views_config.editar_resultado, name='editar_resultado'),
    path('api/admin/excluir-resultado/<int:resultado_id>/', views_config.excluir_resultado, name='excluir_resultado'),
    path('api/admin/criar-passo/', views_config.criar_passo, name='criar_passo'),
    path('api/admin/editar-passo/<int:passo_id>/', views_config.editar_passo, name='editar_passo'),
    path('api/admin/excluir-passo/<int:passo_id>/', views_config.excluir_passo, name='excluir_passo'),
